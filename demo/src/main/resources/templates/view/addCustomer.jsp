...
<div>
<form:form   modelAttribute="customer" action="/demo/view/addCustomer" method="post">
 <table class="table table-stripped table-responsive table-hover">
 <tr>
 <td><form:label path="cid"  >Customer Id:</form:label></td>
 <td><form:input path="cidd" value="${customer.cid}" readonly="true" /></td>
 <td><form:errors path="cid" cssClass="error" /></td>
 </tr>
 
 <tr>
 <td><form:label path="firstName">First Name:</form:label></td>
 <td><form:input path="firstName" value="${customer.cfName}"/></td>
 <td><form:errors path="firstName" cssClass="error" /></td>
 </tr>
 
 <tr>
 <td><form:label path="lastName">Last Name:</form:label></td>
 <td><form:input path="lastName" value="${customer.clName}"/></td>
